 ...
 * Modules in this build: mutex, thread, archive, box2d, graphics, color, box2ddraw, cdrom, draw, ease, erl, font, gamepad, image, imagelist, iop, loop, vector, matrix4, memcard, poweroff, screen, sound, system, tilemap, timer, tween, usbmass, video
 */
...
extern unsigned char athena_js_ease[];
extern unsigned int size_athena_js_ease;
extern unsigned char athena_js_tween[];
extern unsigned int size_athena_js_tween;
...
static const struct {
    ...
    { "Ease", athena_js_ease, &size_athena_js_ease },
    { "Tween", athena_js_tween, &size_athena_js_tween },
    { NULL, NULL, NULL }
};
