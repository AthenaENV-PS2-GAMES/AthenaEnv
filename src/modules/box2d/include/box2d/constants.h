...
/// AthenaEnv: 128 upstream. Every slot is a static b2World (~1.9 KB on the EE),
/// so 128 slots cost ~242 KB of BSS whether or not they are used.
#ifndef B2_MAX_WORLDS
#define B2_MAX_WORLDS 8
#endif
